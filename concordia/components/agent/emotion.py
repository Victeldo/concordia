...
DEFAULT_PRE_ACT_KEY = 'Emotional state of other agents'
...
class Relationships(action_spec_ignored.ActionSpecIgnored):
  """Emotion component, which tracks the emotions of agents."""
  ...
  def _query_memory(self, query: str) -> str:
    ...
    question = (
        'Given the above events, what would you expect to be the emotional state of' f' {query}. '
    )
